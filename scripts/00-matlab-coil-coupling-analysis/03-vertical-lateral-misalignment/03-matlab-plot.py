...
df = pd.read_csv(r'CouplingRX2.csv')
...
# Add labels
ax.set_xlabel('Lateral misalignment [mm]')
...
fig.savefig(f'lateral-vertical-misalignment.pdf', bbox_inches='tight', transparent=True)

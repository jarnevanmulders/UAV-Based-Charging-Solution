...
/* Helper macros for child nodes of this node. */
#define DT_N_S_leds_FOREACH_CHILD(fn) fn(DT_N_S_leds_S_en_1) fn(DT_N_S_leds_S_en_2) fn(DT_N_S_leds_S_bucken_0) fn(DT_N_S_leds_S_pg_0) fn(DT_N_S_leds_S_usrled_0) fn(DT_N_S_leds_S_led_0)
#define DT_N_S_leds_FOREACH_CHILD_SEP(fn, sep) fn(DT_N_S_leds_S_en_1) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_en_2) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_bucken_0) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_pg_0) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_usrled_0) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_led_0)
#define DT_N_S_leds_FOREACH_CHILD_VARGS(fn, ...) fn(DT_N_S_leds_S_en_1, __VA_ARGS__) fn(DT_N_S_leds_S_en_2, __VA_ARGS__) fn(DT_N_S_leds_S_bucken_0, __VA_ARGS__) fn(DT_N_S_leds_S_pg_0, __VA_ARGS__) fn(DT_N_S_leds_S_usrled_0, __VA_ARGS__) fn(DT_N_S_leds_S_led_0, __VA_ARGS__)
#define DT_N_S_leds_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) fn(DT_N_S_leds_S_en_1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_en_2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_bucken_0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_pg_0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_usrled_0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_led_0, __VA_ARGS__)
#define DT_N_S_leds_FOREACH_CHILD_STATUS_OKAY(fn) fn(DT_N_S_leds_S_en_1) fn(DT_N_S_leds_S_en_2) fn(DT_N_S_leds_S_bucken_0) fn(DT_N_S_leds_S_pg_0) fn(DT_N_S_leds_S_usrled_0) fn(DT_N_S_leds_S_led_0)
#define DT_N_S_leds_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) fn(DT_N_S_leds_S_en_1) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_en_2) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_bucken_0) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_pg_0) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_usrled_0) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_led_0)
#define DT_N_S_leds_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) fn(DT_N_S_leds_S_en_1, __VA_ARGS__) fn(DT_N_S_leds_S_en_2, __VA_ARGS__) fn(DT_N_S_leds_S_bucken_0, __VA_ARGS__) fn(DT_N_S_leds_S_pg_0, __VA_ARGS__) fn(DT_N_S_leds_S_usrled_0, __VA_ARGS__) fn(DT_N_S_leds_S_led_0, __VA_ARGS__)
#define DT_N_S_leds_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) fn(DT_N_S_leds_S_en_1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_en_2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_bucken_0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_pg_0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_usrled_0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds_S_led_0, __VA_ARGS__)
...
/* Node's dependency ordinal: */
#define DT_N_S_leds_S_usrled_0_ORD 25
